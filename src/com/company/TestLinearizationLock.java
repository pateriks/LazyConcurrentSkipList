...
public class TestLinearizationLock {
    ...
    LazyConcurrentSkipListLock<Integer> workList = new LazyConcurrentSkipListLock<>();
    Random random = new Random();
    HashMap<Long, Long> times = new HashMap<>();

    public static void main(String[] args) {
        TestLinearizationLock test = new TestLinearizationLock();
    ...
    private class ListTask implements Runnable {
        ...
        int key;
        ForkJoinPool pool;
        LazyConcurrentSkipListLock list;
